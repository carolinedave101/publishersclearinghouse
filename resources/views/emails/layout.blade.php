...
<head>
    ...
    <title>{{ $subject ?? 'Publishers Clearing House' }}</title>
    <style>
                ...
                <table class="email-container" role="presentation" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="email-footer">
                            <p>&copy; {{ date('Y') }} Publishers Clearing House. All rights reserved.</p>
                            <p>This is an automated message. Please do not reply to this email.</p>
                            <p>Need help? Contact our support team at <a href="mailto:{{ $supportEmail ?? 'winnersteam@publishersclearing.info' }}">{{ $supportEmail ?? 'winnersteam@publishersclearing.info' }}</a></p>
                            <p style="margin-top:8px;font-size:11px;color:#4B5563">
                                {{ config('app.url') }} &bull; Over $500 Million Awarded
                            </p>
                        </td>
                    </tr>
                </table>
