...
<?php $component->withAttributes(['wire:submit' => 'save']); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('site_logo_preview')): ?>
            <div class="mb-4 p-4 bg-gray-100 rounded-lg">
                <p class="text-sm font-medium mb-2">Current Logo Preview:</p>
                <img src="<?php echo e(session('site_logo_preview')); ?>" alt="Logo" style="max-height:60px; border-radius:10px;">
            </div>
...
<?php endif; ?>
<?php /**PATH /home/og/Desktop/projects/road/publishersclearinghouse/resources/views/filament/pages/site-settings.blade.php ENDPATH**/ ?>