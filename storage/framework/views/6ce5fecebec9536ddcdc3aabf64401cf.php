...
<body>
<div class="container">
    <div class="header"><h1>New Membership Signup</h1></div>
    <div class="content">
        <p>A new member has signed up:</p>
        <p><strong>Name:</strong> <?php echo e($subscription->subscriber_name); ?></p>
        <p><strong>Email:</strong> <?php echo e($subscription->subscriber_email); ?></p>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subscription->tier): ?>
            <p><strong>Plan:</strong> <?php echo e($subscription->tier->name); ?></p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <p><strong>Status:</strong> <?php echo e(ucfirst($subscription->status)); ?></p>
        <p style="text-align:center;margin-top:30px;">
            <a href="<?php echo e(config('app.url')); ?>/admin/membership-subscriptions/<?php echo e($subscription->id); ?>/edit" style="display:inline-block;padding:12px 30px;background:#1B2A4A;color:#fff;text-decoration:none;border-radius:50px;font-weight:bold;">View in Admin</a>
        </p>
    </div>
...
<?php /**PATH /home/og/Desktop/projects/road/publishersclearinghouse/resources/views/emails/admin-membership-notification.blade.php ENDPATH**/ ?>