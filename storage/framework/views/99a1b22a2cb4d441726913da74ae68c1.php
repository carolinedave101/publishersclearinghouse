<?php $__env->startSection('title', 'Shop - PCH Winners Portal'); ?>
          ...
          x-data="{
            ...
            async placeOrder(e) {
                ...
                try {
                    ...
                    const res = await fetch('<?php echo e(route("shop.order")); ?>', {
                        method: 'POST',
                        body: data,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/og/Desktop/projects/road/publishersclearinghouse/resources/views/pages/shop.blade.php ENDPATH**/ ?>