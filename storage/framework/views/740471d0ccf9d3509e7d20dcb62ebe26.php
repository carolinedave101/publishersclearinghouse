<?php $__env->startSection('title', $game ? 'Spin & Win - PCH Winners Portal' : 'Games - PCH Winners Portal'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-[#0B1424] via-[#1B2A4A] to-[#0B1424]">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$game): ?>
    ...
    <?php elseif(!$isWinner): ?>
        <div class="max-w-7xl mx-auto px-4 py-24 text-center">
            <div class="text-6xl mb-6">🎡</div>
            <h1 class="text-4xl font-bold text-white mb-4"><?php echo e($game->title); ?></h1>
            <p class="text-xl text-white/60 mb-8"><?php echo e($game->description); ?></p>
            <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 max-w-md mx-auto">
                ...
                <div class="flex gap-3 justify-center">
                    <a href="<?php echo e(route('login')); ?>" class="px-6 py-3 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B8960F] text-[#1B2A4A] font-bold hover:scale-105 active:scale-95 transition-transform">
                        Login with Code
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        <div class="text-center mb-8 lg:mb-12">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3"><?php echo e($game->title); ?></h1>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($game->description): ?>
                <p class="text-base md:text-lg text-white/60 max-w-2xl mx-auto"><?php echo e($game->description); ?></p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isWinner): ?>
                <p class="text-white/40 text-sm mt-3">
                    <span class="text-[#D4AF37] font-semibold text-lg" data-remaining-spins><?php echo e($remainingSpins); ?></span> spin(s) remaining today
                </p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
            <div class="max-w-md mx-auto mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-300 text-sm text-center"><?php echo e(session('error')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16">
            ...
            <div class="w-full max-w-md space-y-5">
                    ...
                    <div class="space-y-2" id="prizeList">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                                <span class="w-4 h-4 rounded-full flex-shrink-0 ring-2 ring-white/10" style="background-color: <?php echo e($segment->color); ?>"></span>
                                <span class="text-white/80 text-sm flex-1 font-medium"><?php echo e($segment->label); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($segment->is_jackpot): ?>
                                    <span class="text-xs px-2 py-0.5 rounded-full bg-red-500/25 text-red-300 font-bold tracking-wide">JACKPOT</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($segment->prize_value > 0): ?>
                                    <span class="text-[#D4AF37] text-sm font-bold">$<?php echo e(number_format($segment->prize_value, 0)); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($game->rules): ?>
                    <details class="bg-white/[0.07] backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden shadow-xl">
                        ...
                        <div class="px-5 lg:px-6 pb-4 text-white/50 text-sm leading-relaxed whitespace-pre-line"><?php echo nl2br(e($game->rules)); ?></div>
                    </details>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($game && $isWinner): ?>
<?php $__env->startPush('scripts'); ?>
<script>
    const segments = <?php echo json_encode($segments, 15, 512) ?>;
    const spinUrl = "<?php echo e(route('spin.ajax')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/og/Desktop/projects/road/publishersclearinghouse/resources/views/pages/spin-and-win.blade.php ENDPATH**/ ?>