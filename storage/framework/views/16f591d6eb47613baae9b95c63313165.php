...
<div class="min-h-[calc(100vh-8rem)] bg-gradient-to-br from-[#f5f0e8] to-[#e8e0d0] py-12">
    <div class="max-w-4xl mx-auto px-4">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 rounded-xl bg-white border border-[#D4AF37]/20 text-[#1B2A4A] font-medium hover:bg-[#D4AF37]/5 transition-colors text-sm">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-[#D4AF37]/10">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->address): ?>
                            <p class="text-xs text-[#1B2A4A]/60 mb-3">
                                Ship to: <?php echo e($order->address); ?>, <?php echo e($order->city); ?>, <?php echo e($order->state); ?> <?php echo e($order->zip); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/og/Desktop/projects/road/publishersclearinghouse/resources/views/pages/orders.blade.php ENDPATH**/ ?>